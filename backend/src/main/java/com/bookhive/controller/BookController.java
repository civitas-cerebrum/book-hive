...
public class BookController {
    ...
    public ResponseEntity<Map<String, Object>> getDiscountedPrice(
        ...
        return bookService.findById(id).map(book -> {
            ...
            // BUG: discount calculation is inverted — adds instead of subtracts
            double discountedPrice = originalPrice + (originalPrice * discountPercent / 100);

            // BUG: no validation on discount percentage — allows negative prices or > 100%
            // discountPercent could be 200, -50, etc.
            ...
            // BUG: stock is decremented on price check (should only happen on purchase)
